    ...
    : QDialog(parent), localDevice(new QBluetoothLocalDevice), m_ui(new Ui::BluetoothManager)
{
    ...
    connect(m_ui->listWidget, SIGNAL(itemActivated(QListWidgetItem *)), this,
            SLOT(bluetoothDeviceSelected(QListWidgetItem *)));
    connect(m_ui->listWidget, SIGNAL(itemChanged(QListWidgetItem *)), this,
            SLOT(bluetoothDeviceSelected(QListWidgetItem *)));
