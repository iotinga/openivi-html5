 ...
 * Command line was: qdbusxml2cpp -p OfonoCallVolume phone_hfp_annotated.xml org.ofono.CallVolume
 *
...
public:
    OrgOfonoCallVolumeInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = nullptr);
